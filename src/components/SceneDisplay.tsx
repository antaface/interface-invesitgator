...
const SceneDisplay: React.FC<SceneDisplayProps> = ({
  ...
  const wrapperCls =
    pos
      ? `fixed ${pos} w-[26rem] mx-auto backdrop-blur-md bg-white/10 border border-white/50 rounded-2xl md:rounded-[0_0_32px_32px] shadow-2xl p-8 z-10 before:content-[''] before:absolute before:inset-0 before:rounded-inherit before:border before:border-white/10 before:pointer-events-none space-y-6`
